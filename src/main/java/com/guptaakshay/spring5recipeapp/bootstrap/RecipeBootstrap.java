...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>{
	...
	private List<Recipe> getRecipes(){
        ...
        guacaRecipe.addIngredient(new Ingredient("Kosher salt", new BigDecimal(".5"), teaUom));
        guacaRecipe.addIngredient(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tableUom));
        guacaRecipe.addIngredient(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2), tableUom));
        guacaRecipe.addIngredient(new Ingredient("serrano chiles, stems and seeds removed, minced", new BigDecimal(2), eachUom));
        guacaRecipe.addIngredient(new Ingredient("Cilantro", new BigDecimal(2), tableUom));
