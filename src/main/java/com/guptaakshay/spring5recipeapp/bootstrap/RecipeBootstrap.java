package com.guptaakshay.spring5recipeapp.bootstrap;
...
import com.guptaakshay.spring5recipeapp.domain.Difficulty;
import com.guptaakshay.spring5recipeapp.domain.Ingredient;
import com.guptaakshay.spring5recipeapp.domain.Notes;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>{
	...
	private List<Recipe> getRecipes(){
		...
		guacaRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. "
		...
		guacaNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\r\n" + 
				"\r\n" + 
				"Feel free to experiment! One classic Mexican guacamole has pomegranate seeds and chunks of peaches in it. Try guacamole with added pineapple, mango, or strawberries "
				+ "\r\n\r\n"
        ...
        guacaRecipe.getIngredients().add(new Ingredient("Kosher salt", new BigDecimal(".5"), teaUom, guacaRecipe));
        guacaRecipe.getIngredients().add(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tableUom, guacaRecipe));
        guacaRecipe.getIngredients().add(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2), tableUom, guacaRecipe));
        ...
        guacaRecipe.getIngredients().add(new Ingredient("Cilantro", new BigDecimal(2), tableUom, guacaRecipe));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Salt", new BigDecimal(".5"), teaUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Clove of Garlic, Choppedr", new BigDecimal(1), eachUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("finely grated orange zestr", new BigDecimal(1), tableUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("fresh-squeezed orange juice", new BigDecimal(3), tableUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Olive Oil", new BigDecimal(2), tableUom, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("boneless chicken thighs", new BigDecimal(4), tableUom, tacosRecipe));
